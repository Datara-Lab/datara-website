...
export const promotionsModule: CRMModuleConfig = {
  ...
  description:
    "Condiciones comerciales, beneficios y vigencias disponibles para los productos y servicios.",
  ...
  fields: [
    {
      ...
      placeholder: "Ej. 12 meses sin intereses",
...

    {
      ...
      description:
        "Productos o servicios a los que puede aplicarse esta promoción.",
...

    {
      ...
      placeholder:
        "Ej. Obtén tu producto a 12 meses sin intereses.",
